class SlugGenerator
  ...
  # SYLLABLES = %w(ba be bi bo bu by da de di do du dy fa fe fi fo fu fy ga ge
  #   gi go gu gy ha he hi ho hu hy ja je ji jo ju jy ka ke ki ko ku ky la le
  #   li lo lu ly ma me mi mo mu my na ne ni no nu ny pa pe pi po pu py ra re
  #   ri ro ru ry sa se si so su sy ta te ti to tu ty va ve vi vo vu vy bra bre
